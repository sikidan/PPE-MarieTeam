						...
						<div class="intro-desc">
							<div class="text-salebox">
								...
								<div class="text-rights">
									...
									<p><a href="#" class="btn btn-primary">MT2018</a></p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
						...
						<p>Nous vous présentons l'equipe qui é réalisé le projet MarieTeam</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="owl-carousel2">
							<div class="item">
								<div class="testimony text-center">
									...
									<span class="user">Remy Bouchez</span>
