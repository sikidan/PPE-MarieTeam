                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase"><b>Chiffre d'affaires</b></h4>
                        ...
                        <div class="col-lg-6 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Nombre de passagers transportés</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject text-uppercase"><b>Nombre de passagers transportés par catégories</b></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="white-box analytics-info-cs mg-b-30 res-mg-t-30">
                            <h3 class="box-title">Total des membres</h3>
                        ...
                        <div class="white-box analytics-info-cs mg-b-30">
                            <h3 class="box-title">Total des réservations</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                        ...
                        <div class="white-box analytics-info-cs mg-b-30">
                            <h3 class="box-title">Total des liaisons existante</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                        ...
                        <div class="white-box analytics-info-cs">
                            <h3 class="box-title">Chiffre d'affaires maximum</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
