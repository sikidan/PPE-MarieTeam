...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<!-- Flaticons  -->
	<link rel="stylesheet" href="fonts/flaticon/font-collection/flaticon.css">
					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li><a href="blog.html">Connexion/Inscription</a></li>
...
<!--											
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															<label for="adultes">Combien de véhicule(s) de - de 3m</label>
															<div class="form-field">
																<i class="icon icon-arrow-down3"></i>
...
!-->												
				         ...
				         <div id="hotel" class="tab-pane fade">
						    <form method="post" action="reservationFret.php" class="colorlib-form">
				              	<div class="row">
				              	 <div class="col-md-9">
				              	 	<div class="booknow">
				              	 		<h2>Service non disponible</h2>
					              	 	<span>L'entreprise MarieTeam s'éfforce de toujours vous en proposez plus, cependant le transport de fret n'est pas encore disponible pour le moment.</span>
				              	 	</div>
				              	 </div>
				                </div>
				            </form>
				...
				<div class="row no-gutters">
					<div class="col-md-3 animate-box text-center aside-stretch">
						<div class="services">
							...
							<h3>Le transport</h3>
							<p>Notre vocation premiére, vous assurez un transport fiable et en toute sécurité</p>
						</div>
					</div>
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							...
							<h3>Vos véhicules</h3>
							<p>Grace a nos formules, nous vous offrons la possiblité d'emmenner votre véhicules en voyage</p>
						</div>
					</div>
					<div class="col-md-3 animate-box text-center">
						<div class="services">
		...
		<div id="colorlib-testimony" class="colorlib-light-grey">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
						<h2>L'équipe MarieTeam</h2>
						<p>Nous vous présentons l'equipe qui à réalisé le projet MarieTeam</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="owl-carousel2">
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/remy.jpg);"></span>
									<span class="user">Rémy Bouchez</span>
									<small>Lille, France</small>
									<blockquote>
										<p>Etudiant dévelloppeur en BTS SIO SLAM et chef du projet MarieTeam</p>
									</blockquote>
								</div>
							</div>
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/alexandre.jpg);"></span>
									<span class="user">Alexandre Cadren</span>
									<small>Béthune, France</small>
									<blockquote>
										<p>Etudiant dévelloppeur en BTS SIO SLAM</p>
									</blockquote>
								</div>
							</div>
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/deny.jpg);"></span>
									<span class="user">Deny Vanquickelberge</span>
									<small>Orchies, Francee</small>
									<blockquote>
										<p>Etudiant dévelloppeur en BTS SIO SLAM</p>
									</blockquote>
								</div>
